#!/usr/bin/env bash
#SBATCH --job-name=scfm_dataset_reports
...
#SBATCH --mem=128G
#SBATCH --array=0-11%2
#SBATCH --output=/n/holylabs/rongma_lab/Lab/scaling_law/reports/logs/dataset_report_%A_%a.out
#SBATCH --error=/n/holylabs/rongma_lab/Lab/scaling_law/reports/logs/dataset_report_%A_%a.err
